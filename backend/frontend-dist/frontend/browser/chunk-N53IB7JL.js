...
var _FillGradient = class _FillGradient2 {
  constructor(...args) {
    ...
    options = __spreadValues(__spreadValues({}, defaults), definedProps(options));
...
function generateTextureMatrix(out2, style, shape, matrix) {
  ...
  if (style.textureSpace === "local") {
    const bounds = shape.getBounds(tempRect3);
    if (style.width) {
...
function toStrokeStyle(value, defaultStyle) {
  const _a = defaultStyle, { width, alignment, miterLimit, cap, join, pixelLine } = _a, rest = __objRest(_a, ["width", "alignment", "miterLimit", "cap", "join", "pixelLine"]);
...
//# sourceMappingURL=chunk-N53IB7JL.js.map
