...
var RenderTexture = class _RenderTexture extends Texture {
  ...
  static create(options) {
    const _a = options, { dynamic, textureOptions } = _a, rest = __objRest(_a, ["dynamic", "textureOptions"]);
    return new _RenderTexture(__spreadProps(__spreadValues({}, textureOptions), {
...
//# sourceMappingURL=chunk-PYFMMMK4.js.map
