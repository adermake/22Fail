...
@Component({
  selector: 'app-sheet',
  imports: [StatsComponent, CharacterComponent, LevelclassComponent, CurrentstatComponent, CurrentstatsComponent, PortraitComponent],
...
export class SheetComponent implements OnInit {
  ...
  constructor( private route: ActivatedRoute) {}
    async ngOnInit() {
      ...
      this.sheetservice.currentSheet = await this.sheetservice.loadCharacter(this.sheetservice.characterSheetId);
