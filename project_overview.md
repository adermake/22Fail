...
- **Drag vs. Klick**: `DRAG_THRESHOLD` (4px) trennt beides; nach einem echten Drag unterdrückt `suppressClick` den nachfolgenden Klick, sonst würde das Loslassen das Teil in der Hand anstecken.
